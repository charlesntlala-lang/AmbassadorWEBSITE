...
const features = [
  ...
  },
  {
    ...
    description:
      "Experienced educators dedicated to nurturing each student's unique potential.",
  },
  {
    icon: BookOpen,
    title: "Modern Resources",
    description:
      "State-of-the-art facilities and learning materials for comprehensive education.",
  },
  {
    icon: Target,
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt="Students at Ambassador International School"
                fill
                priority
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              Ambassador International School is a premier educational
              institution in Lesotho, committed to providing exceptional
              learning experiences. Since our founding, we have been dedicated
              to nurturing young minds and preparing students for the challenges
              of tomorrow.
            </p>
